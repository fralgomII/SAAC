...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 08, 2024 at 04:55 AM
...
CREATE TABLE `aportes` (
  ...
  `asociado_id` bigint(20) UNSIGNED DEFAULT NULL,
  `valor_aporte` decimal(10,2) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `asociados` (
  ...
  `lugar_expedicion` varchar(30) DEFAULT NULL,
  `dpto_expedicion` varchar(30) DEFAULT NULL,
  `fecha_nacimiento` date DEFAULT NULL,
  `edad` varchar(3) DEFAULT NULL,
  `lugar_nacimiento` varchar(30) DEFAULT NULL,
  `dpto_nacimiento` varchar(30) DEFAULT NULL,
...
INSERT INTO `asociados` (`id`, `fecha_afiliacion`, `nombre`, `genero`, `tipo_documento`, `cedula`, `fecha_expedicion`, `lugar_expedicion`, `dpto_expedicion`, `fecha_nacimiento`, `edad`, `lugar_nacimiento`, `dpto_nacimiento`, `telefono`, `direccion`, `ciudad`, `dpto`, `email`, `estado_civil`, `tipo_vivienda`, `zona`, `estrato`, `personas`, `nivel_educativo`, `profesion`, `estado`, `created_at`, `updated_at`) VALUES
(1, '2024-04-05', 'Franklin Albeiro Gómez Mendoza', 'Masculino', 'C.C.', '88227526', '1995-07-21', '275', '54', '1977-07-16', '46', '275', '54', '3112543996', 'arboretto b31', '275', '54', 'franklin.gomezm@unisimon.edu.co', 'Casado(a)', 'Propia', 'Urbana', 3, 3, 'Magister', 'Profesor', 'Activo', '2024-04-05 20:30:35', '2024-04-05 20:30:35'),
(2, '2024-04-05', 'Rossy Emily Patricia Ortega', 'Femenino', 'C.C.', '37397855', '2000-07-21', '275', '54', '1984-05-17', '39', '275', '54', '3115283741', 'arboretto b31', '1059', '54', 'repop_23@hotmail.com', 'Casado(a)', 'Propia', 'Urbana', 3, 1, 'Especialista', 'Ingeniera', 'Activo', '2024-04-05 20:44:20', '2024-04-05 20:44:20');
...
CREATE TABLE `creditos` (
  ...
  `seguro_deudor` decimal(5,2) NOT NULL,
  `seguro_credito` decimal(5,2) NOT NULL,
...
INSERT INTO `creditos` (`id`, `fecha_credito`, `asociado_id`, `lineacredito_id`, `interes_credito`, `seguro_deudor`, `seguro_credito`, `plazo_credito`, `valor_credito`, `valor_cuota`, `estado`, `created_at`, `updated_at`) VALUES
(1, '2024-04-05', 1, 1, 1.90, 0.05, 0.09, '12', 15600000.00, 1466085.29, 'Solicitado', '2024-04-06 03:28:01', '2024-04-06 03:28:01');
...
INSERT INTO `egresos` (`id`, `fecha_egreso`, `asociado_id`, `valor_egreso`, `created_at`, `updated_at`) VALUES
(1, '2024-04-06', 1, 895000.00, '2024-04-06 06:06:32', '2024-04-06 06:33:28');
...
--
-- Table structure for table `lineaaportes`
--
...
--
-- Dumping data for table `lineaaportes`
--

INSERT INTO `lineaaportes` (`id`, `nombre`, `estado`, `created_at`, `updated_at`) VALUES
(1, 'Aporte Voluntario', 'Activo', NULL, NULL),
(2, 'Aporte a Fondo de Vivienda', 'Activo', NULL, NULL),
(3, 'Aporte a Fondo de Vehiculo', 'Activo', NULL, NULL),
(4, 'Aporte a Fondo de Microempresa', 'Activo', NULL, NULL),
(5, 'Aporte a Fondo de la Vista', 'Activo', NULL, NULL),
(6, 'Aporte para Ahorro Programado', 'Activo', NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `lineacreditos`
--
...
CREATE TABLE `lineacreditos` (
  ...
  `seguro_vida` decimal(5,2) DEFAULT NULL,
  `seguro_credito` decimal(5,2) DEFAULT NULL,
  `estado` varchar(20) DEFAULT 'Activo',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Dumping data for table `lineacreditos`
--

INSERT INTO `lineacreditos` (`id`, `nombre`, `plazo`, `valor`, `interes`, `seguro_vida`, `seguro_credito`, `estado`, `created_at`, `updated_at`) VALUES
(1, 'Libre Inversión', '24', 5000000, 1.90, 0.03, 0.05, 'Activo', '2024-03-20 11:07:14', '2024-04-06 16:40:42'),
(2, 'Especial Aportes', '12', 5000000, 1.00, 0.00, 0.00, 'Activo', '2024-03-20 11:07:14', '2024-03-20 11:07:14'),
(3, 'Compra de Cartera', '24', 5000000, 1.00, 0.00, 0.00, 'Activo', '2024-03-20 11:07:14', '2024-03-20 11:07:14'),
(4, 'Tarjeta Rotativa', '24', 5000000, 2.00, 0.00, 0.00, 'Activo', '2024-03-20 11:07:14', '2024-03-20 11:07:14'),
(5, 'Crédito vehiculo (Moto)', '24', 7000000, 1.60, 0.00, 0.00, 'Activo', '2024-03-20 11:07:14', '2024-03-20 11:07:14'),
(6, 'Crédito Educativo', '6', 3000000, 1.50, 0.00, 0.00, 'Activo', '2024-03-20 11:07:14', '2024-03-20 11:07:14'),
(7, 'Credilicencias', '6', 2000000, 2.00, 0.00, 0.00, 'Activo', '2024-03-20 11:07:14', '2024-03-20 11:07:14'),
(8, 'Crédito Progresando', '24', 10000000, 1.30, 0.00, 0.00, 'Activo', '2024-03-20 11:07:14', '2024-03-20 11:07:14');
...
(9, '2024_02_07_134822_create_aportes_table', 1),
...
(19, '2024_03_18_083749_create_linea_aportes_table', 1),
(20, '2024_04_06_003933_create_egresos_table', 2);
...
--
-- Table structure for table `movimiento_abonos`
--
...
--
-- Table structure for table `movimiento_creditos`
--
...
--
-- Table structure for table `movimiento_pago_aportes`
--
...
--
-- Table structure for table `movimiento_pago_creditos`
--
...
--
-- Table structure for table `pago_aportes`
--
...
--
-- Table structure for table `pago_creditos`
--
...
INSERT INTO `periodos` (`id`, `mes`, `año`, `nombre`, `estado`, `created_at`, `updated_at`) VALUES
(1, '1', '2024', 'Enero 2024', 'Abierto', '2024-04-06 15:56:41', '2024-04-06 15:56:41'),
(2, '2', '2024', 'Febrero 2024', 'Cerrado', '2024-04-06 15:57:29', '2024-04-06 15:57:29'),
(3, '3', '2024', 'Marzo 2024', 'Cerrado', '2024-04-06 15:58:47', '2024-04-06 15:58:47'),
(5, '4', '2024', 'Abril 2024', 'Cerrado', '2024-04-06 16:06:55', '2024-04-06 16:06:55'),
(6, '5', '2024', 'Mayo 2024', 'Cerrado', '2024-04-06 16:08:41', '2024-04-06 16:08:41'),
(7, '6', '2024', 'Junio 2024', 'Cerrado', '2024-04-06 16:11:26', '2024-04-06 16:11:26');
...
(1, 'home', 'web', '2024-03-20 11:07:09', '2024-03-20 11:07:09'),
(2, 'ver-asociados', 'web', '2024-03-20 11:07:09', '2024-03-20 11:07:09'),
(3, 'crear-asociados', 'web', '2024-03-20 11:07:09', '2024-03-20 11:07:09'),
(4, 'editar-asociados', 'web', '2024-03-20 11:07:09', '2024-03-20 11:07:09'),
(5, 'borrar-asociados', 'web', '2024-03-20 11:07:09', '2024-03-20 11:07:09'),
(6, 'ver-aportes', 'web', '2024-03-20 11:07:10', '2024-03-20 11:07:10'),
(7, 'crear-aportes', 'web', '2024-03-20 11:07:10', '2024-03-20 11:07:10'),
(8, 'editar-aportes', 'web', '2024-03-20 11:07:10', '2024-03-20 11:07:10'),
(9, 'borrar-aportes', 'web', '2024-03-20 11:07:10', '2024-03-20 11:07:10'),
(10, 'ver-linea_aportes', 'web', '2024-03-20 11:07:10', '2024-03-20 11:07:10'),
(11, 'crear-linea_aportes', 'web', '2024-03-20 11:07:10', '2024-03-20 11:07:10'),
(12, 'editar-linea_aportes', 'web', '2024-03-20 11:07:10', '2024-03-20 11:07:10'),
(13, 'borrar-linea_aportes', 'web', '2024-03-20 11:07:10', '2024-03-20 11:07:10'),
(14, 'ver-estado', 'web', '2024-03-20 11:07:10', '2024-03-20 11:07:10'),
(15, 'ver-lineacreditos', 'web', '2024-03-20 11:07:11', '2024-03-20 11:07:11'),
(16, 'crear-lineacreditos', 'web', '2024-03-20 11:07:11', '2024-03-20 11:07:11'),
(17, 'editar-lineacreditos', 'web', '2024-03-20 11:07:11', '2024-03-20 11:07:11'),
(18, 'borrar-lineacreditos', 'web', '2024-03-20 11:07:11', '2024-03-20 11:07:11'),
(19, 'ver-creditos', 'web', '2024-03-20 11:07:11', '2024-03-20 11:07:11'),
(20, 'crear-creditos', 'web', '2024-03-20 11:07:11', '2024-03-20 11:07:11'),
(21, 'editar-creditos', 'web', '2024-03-20 11:07:12', '2024-03-20 11:07:12'),
(22, 'borrar-creditos', 'web', '2024-03-20 11:07:12', '2024-03-20 11:07:12'),
(23, 'ver-abonos', 'web', '2024-03-20 11:07:12', '2024-03-20 11:07:12'),
(24, 'crear-abonos', 'web', '2024-03-20 11:07:12', '2024-03-20 11:07:12'),
(25, 'editar-abonos', 'web', '2024-03-20 11:07:12', '2024-03-20 11:07:12'),
(26, 'borrar-abonos', 'web', '2024-03-20 11:07:12', '2024-03-20 11:07:12'),
(27, 'ver-simulador', 'web', '2024-03-20 11:07:12', '2024-03-20 11:07:12'),
(28, 'ver-liquidador', 'web', '2024-03-20 11:07:12', '2024-03-20 11:07:12'),
(29, 'ver-configuracion', 'web', '2024-03-20 11:07:13', '2024-03-20 11:07:13'),
(30, 'editar-configuracion', 'web', '2024-03-20 11:07:13', '2024-03-20 11:07:13'),
(31, 'ver-roles', 'web', '2024-03-20 11:07:13', '2024-03-20 11:07:13'),
(32, 'crear-roles', 'web', '2024-03-20 11:07:13', '2024-03-20 11:07:13'),
(33, 'editar-roles', 'web', '2024-03-20 11:07:13', '2024-03-20 11:07:13'),
(34, 'borrar-roles', 'web', '2024-03-20 11:07:13', '2024-03-20 11:07:13'),
(35, 'ver-usuarios', 'web', '2024-03-20 11:07:13', '2024-03-20 11:07:13'),
(36, 'crear-usuarios', 'web', '2024-03-20 11:07:13', '2024-03-20 11:07:13'),
(37, 'editar-usuarios', 'web', '2024-03-20 11:07:14', '2024-03-20 11:07:14'),
(38, 'borrar-usuarios', 'web', '2024-03-20 11:07:14', '2024-03-20 11:07:14');
...
(1, 'Administrador', 'web', '2024-03-20 11:07:08', '2024-03-20 11:07:08'),
(2, 'Digitador', 'web', '2024-03-20 11:07:08', '2024-03-20 11:07:08');
...
(1, 'Franklin Albeiro Gómez Mendoza', 'fralgom@gmail.com', '2024-03-20 11:07:16', '$2y$12$X0qOao.Eyre.CNtI1sbGcu4e3QYGFYHMbTjuQZz0VmMbEVnG1lhRK', 'N9FqAB319hwOCUDtBRZ1G4MBsZO2lPASkqGQHK74K2fxIfr05KGJYY4N68fK', '2024-03-20 11:07:16', '2024-03-20 11:07:16'),
(2, 'Emily Patricia Ortega', 'repop_23@hotmail.com', NULL, '$2y$12$0eLBioHv3W3yppyT06NW6uqsfkV86q7Z3fmVl5AiKP2LnYayozEXu', NULL, '2024-04-06 03:29:20', '2024-04-06 03:29:20');
...
ALTER TABLE `aportes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `aportes_asociado_id_foreign` (`asociado_id`);
...
ALTER TABLE `egresos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `egresos_asociado_id_foreign` (`asociado_id`);
...
--
-- Indexes for table `lineaaportes`
--
ALTER TABLE `lineaaportes`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `lineacreditos`
--
...
--
-- Indexes for table `movimiento_abonos`
--
ALTER TABLE `movimiento_abonos`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `movimiento_creditos`
--
ALTER TABLE `movimiento_creditos`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `movimiento_pago_aportes`
--
ALTER TABLE `movimiento_pago_aportes`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `movimiento_pago_creditos`
--
...
--
-- Indexes for table `pago_aportes`
--
ALTER TABLE `pago_aportes`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pago_creditos`
--
...
--
-- AUTO_INCREMENT for table `lineaaportes`
--
ALTER TABLE `lineaaportes`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `lineacreditos`
--
ALTER TABLE `lineacreditos`
...
--
-- AUTO_INCREMENT for table `movimiento_abonos`
--
ALTER TABLE `movimiento_abonos`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `movimiento_creditos`
--
ALTER TABLE `movimiento_creditos`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `movimiento_pago_aportes`
--
ALTER TABLE `movimiento_pago_aportes`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `movimiento_pago_creditos`
--
ALTER TABLE `movimiento_pago_creditos`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `pago_aportes`
--
ALTER TABLE `pago_aportes`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pago_creditos`
--
ALTER TABLE `pago_creditos`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `aportes`
  ADD CONSTRAINT `aportes_asociado_id_foreign` FOREIGN KEY (`asociado_id`) REFERENCES `asociados` (`id`) ON DELETE SET NULL;
...
--
ALTER TABLE `egresos`
  ADD CONSTRAINT `egresos_asociado_id_foreign` FOREIGN KEY (`asociado_id`) REFERENCES `asociados` (`id`) ON DELETE SET NULL;
